...
$(document).ready(function() {
  var kanban_curr_el, kanban_curr_item_id, kanban_item_title, kanban_data, kanban_item, kanban_users,list = [];
...
// console.log(kanban_board_data);
  ...
  $(".delete-kanban-item").on("click", function() {
    ...
    console.log(KanbanExample.getParentBoardID(kanban_curr_item_id));
    addEventListener("click", function() {
